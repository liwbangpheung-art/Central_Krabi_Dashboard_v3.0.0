...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/audit-logs", label: "ประวัติการกระทำ", icon: "shield", permission: "view_audit_logs" },
      { to: "/permission-matrix", label: "Permission Matrix", icon: "matrix", permission: "manage_users" }
    ]
  }
];
