...
import { BarChart3, Bot, CalendarDays, FileText, UsersRound, SlidersHorizontal, Settings, UploadCloud, Table, ShieldCheck } from 'lucide-react'
      ...
      <aside className="sidebar">
        ...
        <div className="user-profile-card" style={{
          ...
          <div style={{ borderTop: '1.5px solid rgba(255, 255, 255, 0.5)', marginTop: '8px', paddingTop: '8px', fontSize: '11px', display: 'grid', gap: '4px' }}>
            ...
            <div>
              <span style={{ color: '#64748b', display: 'block', marginBottom: '2px' }}>สิทธิ์เข้าถึง ({permissions.length}):</span>
