...
import { DataEntryHubPage } from "./pages/DataEntryHubPage.jsx";
import { BulkDataPage } from "./pages/BulkDataPage.jsx";
import { ComparisonPage } from "./pages/ComparisonPage.jsx";
import { PreviewHomePage } from "./pages/PreviewHomePage.jsx";
import { PreviewInputPage } from "./pages/PreviewInputPage.jsx";
import { PreviewDashboardPage } from "./pages/PreviewDashboardPage.jsx";
import { PreviewPowerPointPage } from "./pages/PreviewPowerPointPage.jsx";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<ProtectedApp config={config} />}>
            ...
            <Route path="preview/input" element={<PreviewInputPage />} />
            <Route path="preview/dashboard" element={<PreviewDashboardPage />} />
            <Route path="preview/powerpoint" element={<PreviewPowerPointPage />} />
            <Route path="master-data" element={<MasterDataPage />} />
            <Route path="daily-entry" element={<DailyEntryPage />} />
            <Route path="entry" element={<DataEntryHubPage />} />
